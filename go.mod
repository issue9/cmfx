...
require (
	...
	github.com/issue9/logs/v4 v4.0.0-beta.5 // indirect
	github.com/issue9/mux/v7 v7.0.0-beta.5 // indirect
	github.com/issue9/query/v3 v3.1.0 // indirect
