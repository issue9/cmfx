...
type memberInfoVO struct {
	...
	Avatar   string     `json:"avatar,omitempty" xml:"avatar,omitempty" toml:"avatar,omitempty" cbor:"avatar,omitempty" yaml:"avatar,omitempty"`
	Level    int64      `json:"level,omitempty" yaml:"level,omitempty" toml:"level,omitempty" xml:"level,attr,omitempty" cbor:"level,omitempty"`
	Type     int64      `json:"type,omitempty" yaml:"type,omitempty" toml:"type,omitempty" xml:"type,attr,omitempty" cbor:"type,omitempty"`
...
type memberInfoTO struct {
	memberInfoPathTO
	Username  string `json:"username" yaml:"username" xml:"username" cbor:"username" toml:"username" comment:"username"`
	Password  string `json:"password" yaml:"password" xml:"password" cbor:"password" toml:"password" comment:"password"`
	Inviter   string `json:"inviter,omitempty" yaml:"inviter,omitempty" xml:"inviter,omitempty" toml:"inviter,omitempty" cbor:"inviter,omitempty" comment:"inviter"`
	inviterID int64
}
