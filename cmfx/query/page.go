...
type Page[T any] struct {
	XMLName struct{} `json:"-" xml:"page" cbor:"-"`
	Count   int64    `json:"count" xml:"count,attr" cbor:"count"`                            // 符合条件的所有数据
	Current []*T     `json:"current"  xml:"current" cbor:"current"`                          // 当前页的数据
	More    bool     `json:"more,omitempty" xml:"more,attr,omitempty" cbor:"more,omitempty"` // 是否还有更多的数据
}
