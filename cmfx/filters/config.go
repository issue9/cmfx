...
type Config struct {
	// Keywords 按关键字过滤
	Keywords []string `json:"keywords" yaml:"keywords" cbor:"keywords" toml:"keywords" setting:"keywords" comment:"keyword filter"`

	// URLBlacklist  地址黑名单
	URLBlacklist []string `json:"urlBlacklist" yaml:"urlBlacklist" cbor:"urlBlacklist" toml:"urlBlacklist" setting:"urlBlacklist" comment:"url blacklist filter"`
}
