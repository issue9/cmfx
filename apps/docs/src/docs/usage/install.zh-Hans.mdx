...
如果只是作一个简单的项目，可以跳过安装步骤，直接在 `apps` 下作开发：
...
npm i @cmfx/admin @cmfx/core @cmfx/cdk @cmfx/components @cmfx/illustrations
```
...
@import '@cmfx/cdk/tailwind.css';         /* 导入 tailwind 样式的修改 */
@import '@cmfx/cdk/style.css';            /* 导入 cdk 中的样式 */
