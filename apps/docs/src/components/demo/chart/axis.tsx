...
import { ChartAxis } from '@cmfx/components';
		...
		<div>
			...
			<div>
				<ChartAxis
					...
					series={[
						{ type: 'line', key: 'v1' },
						{ type: 'bar', key: 'v2', yAxisIndex: 1, area: true },
					]}
					initValue={items}
				/>
			</div>
			...
			<div>
				<ChartAxis
					...
					xAxis={{ name: 'X', key: 'name' }}
					series={[
						{ type: 'bar', key: 'v2', yAxisIndex: 1, smooth: true },
						{ type: 'line', key: 'v1', area: true, smooth: true },
					]}
					initValue={items}
				/>
			</div>
