...
export default function(): JSX.Element {
    ...
    return <div>
        ...
        <Button ref={el=>el.element().id='b1'} onclick={() => ref.start()}>start</Button>
        <Button ref={el=>el.element().id='b2'}>2222</Button>
        <Button ref={el=>el.element().id='b3'}>3333</Button>
        <Button ref={el=>el.element().id='b4'} class="ms-[200px]">4444</Button>
    </div>;
}
