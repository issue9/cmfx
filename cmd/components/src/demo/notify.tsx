...
import { Button, notify, NotifyType, notifyTypes, useLocale, useOptions } from '@cmfx/components';
...
export default function() {
    ...
    const notify1 = async(): Promise<void> => {
        await notify(title(), body(), type(), l.locale.toString(), timeout() || o.notifyTimeout);
    };
