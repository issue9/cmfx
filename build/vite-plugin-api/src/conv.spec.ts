...
describe('conv', () => {
    ...
    test('typeAlias', () => {
        ...
        const alias = conv(items![0]);
        expect(alias.kind).toEqual('typeAlias');

        if (alias.kind === 'typeAlias') {
