...
export type ValueType = [start?: Date, end?: Date];

/**
 * 获取相对于 date 的上个月
 */
export function prevMonth(date?: Date): ValueType {
	const d = getYMD(date);
 ...
 * 获取相对于 date 的上一个季度
 */
export function prevQuarter(date?: Date): ValueType {
	const d = getYMD(date);
 ...
 * 获取相对于 date 的当前季度
 */
export function thisQuarter(date?: Date): ValueType {
	const d = getYMD(date);
 ...
 * 获取相对于 date 的下一个季度
 */
export function nextQuarter(date?: Date): ValueType {
	const d = getYMD(date);
 ...
 * 获取相对于 date 的上一年份
 */
export function prevYear(date?: Date): ValueType {
	const d = getYMD(date);
 ...
 * 获取相对于 date 的本年份
 */
export function thisYear(date?: Date): ValueType {
	const d = getYMD(date);
 ...
 * 获取相对于 date 的下一年份
 */
export function nextYear(date?: Date): ValueType {
	const d = getYMD(date);
