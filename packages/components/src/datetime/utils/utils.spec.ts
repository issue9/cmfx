...
test('getWeekDays', () => {
	expect(
		...
		[
			[false, new Date(2024, 5, 29)],
			[false, new Date(2024, 5, 30)],
			[true, new Date(2024, 6, 1)],
			[true, new Date(2024, 6, 2)],
			[true, new Date(2024, 6, 3)],
			[true, new Date(2024, 6, 4)],
			[true, new Date(2024, 6, 5)],
		],
		[
			[true, new Date(2024, 6, 6)],
			[true, new Date(2024, 6, 7)],
			[true, new Date(2024, 6, 8)],
			[true, new Date(2024, 6, 9)],
			[true, new Date(2024, 6, 10)],
			[true, new Date(2024, 6, 11)],
			[true, new Date(2024, 6, 12)],
		],
		[
			[true, new Date(2024, 6, 13)],
			[true, new Date(2024, 6, 14)],
			[true, new Date(2024, 6, 15)],
			[true, new Date(2024, 6, 16)],
			[true, new Date(2024, 6, 17)],
			[false, new Date(2024, 7, 1)],
			[false, new Date(2024, 7, 2)],
		],
	]);
});
