...
export function Number(props: Props): JSX.Element {
    ...
    const Trigger = (p: { style?: BaseProps['style'] }) => {
        ...
        return <Input type='number' id={id} prefix={props.prefix} suffix={suffix} rounded={props.rounded}
            inputMode={props.inputMode} tabindex={props.tabindex} disabled={props.disabled}
