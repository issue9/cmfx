...
import { type BaseRef, joinClass, type ThemeProps, type ValueProps } from '@cmfx/cdk';
...
export interface UploadProps extends Omit<Form.InputProps, 'rounded'>, ValueProps<Array<string>>, ThemeProps {
	/**
	 * 上传文件在表单中的名称
	 */
	fieldName: string;
