...
interface DateProps extends Base {
	accessor: Form1.Accessor<DateRangePanel.ValueType | undefined, 'date'>;
}

interface NumberProps extends Base {
	accessor: Form1.Accessor<[start: number | undefined, end: number | undefined] | undefined, 'number'>;
}

interface StringProps extends Base {
	accessor: Form1.Accessor<[start: string | undefined, end: string | undefined] | undefined, 'string'>;
}
...
export function Root(props: Props): JSX.Element {
	if (isDateProps(props)) {
		...
		const rng: DateRangePanel.ValueType | undefined = val
			...
			: undefined;
		const accessor = Form1.fieldAccessor('accessor', rng, 'date');
