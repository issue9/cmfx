...
export interface Props extends Form1.FieldBaseProps, RefProps<Ref> {
	 ...
	 * NOTE: 非响应式属性
	 */
	accessor: Form1.Accessor<number | undefined>;
	 ...
	 * @reactive
	 */
	inputMode?: Input.NumberProps['inputMode'];
}
...
export function Root(props: Props): JSX.Element {
	const form = Form1.useForm(); // Numeric 在 textfield 的外层，所以得保证 useForm 是可用的。
	...
	return (
		...
		>
			...
			<Trigger style={Form1.fieldArea2Style(areas().inputArea)} />
