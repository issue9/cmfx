...
class CacheImplement implements Cache {
    ...
    async keys(_?: RequestInfo | URL, __?: CacheQueryOptions): Promise<ReadonlyArray<Request>> { return []; }
    async match(_: RequestInfo | URL, __?: CacheQueryOptions): Promise<Response | undefined> { return; }
    async matchAll(_?: RequestInfo | URL, __?: CacheQueryOptions): Promise<ReadonlyArray<Response>> { return []; }
