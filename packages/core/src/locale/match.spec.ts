...
describe('match', () => {
    ...
    test('best fit', () => {
        ...
        expect(match('zh-hans-CN', ['zh-Hans', 'zh', 'zh-Hans-CN'], 'und', { localeMatcher: 'best fit' })).toEqual('zh-Hans-CN'); // 不同的大小写，不触发 best fit
        ...
        expect(match('zh-CN', ['zh-Hans', 'zh', 'zho-Hans-CN'], 'und', { localeMatcher: 'best fit' })).toEqual('zho-Hans-CN');
