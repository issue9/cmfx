...
// https://storyset.com/illustration/403-error-forbidden/bro
export default function BroError403(props: Props): JSX.Element {
	const l = useLocale();
		...
		<svg {...buildStorySetProps(props)}>
			...
			<g id="freepik--Padlock--inject-4">
				<path
					...
					style="fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.17px"
				/>
				<rect
					x="65.14"
					y="179.87"
			...
			<g id="freepik--Character--inject-4">
				...
				<path
					...
					style="fill:var(--palette-bg);stroke:var(--palette-border-low);stroke-linecap:round;stroke-linejoin:round;stroke-width:1.17px"
				/>
				<path
				...
				<polygon
					...
					style="fill:var(--palette-bg-high);stroke:var(--palette-border-low);stroke-linecap:round;stroke-linejoin:round;stroke-width:1.17px"
				/>
				<circle
					cx="225.35"
					cy="223.52"
				...
				<path
					...
					style="fill:none;stroke:var(--palette-border-low);stroke-linecap:round;stroke-linejoin:round;stroke-width:1.17px"
				/>
				<ellipse
					cx="249.9"
					cy="202.02"
			...
			<text x="356" y="208" text-anchor="middle" style="font-size:5.5rem;font-weight:bold;fill:currentColor">
				403
			</text>
			<text x="355" y="250" text-anchor="middle" style="font-size:1.5rem;fill:currentColor">
				{props.text || l.t('_i.forbidden')}
			</text>
			<g id="freepik--security-barrier--inject-4">
				<polygon
					points="86.87 446.5 72.61 446.5 91.62 313.99 105.88 313.99 86.87 446.5"
					style="fill:var(--illustration-text);stroke:var(--illustration-bg);stroke-miterlimit:10;stroke-width:1.17px"
				/>
				<polygon
					points="115.39 446.5 129.64 446.5 110.63 313.99 96.38 313.99 115.39 446.5"
					style="fill:var(--illustration-bg);stroke:var(--illustration-text);stroke-miterlimit:10;stroke-width:1.17px"
				/>
				<polygon
				...
				<rect
					...
					width="271.93"
					height="26.36"
					style="fill:var(--palette-bg);stroke:var(--illustration-text);stroke-miterlimit:10;stroke-width:1.17px"
				/>
				<rect
					x="62.36"
					y="293.21"
				...
				<line
					...
					x2="287.8"
					y2="304.9"
					style="fill:none;stroke:var(--illustration-text);stroke-miterlimit:10;stroke-width:1.17px"
				/>
				<line
					x1="332.01"
					y1="309.31"
				...
				<rect
					...
					width="77.14"
					height="5.79"
					style="fill:var(--illustration-text);stroke:var(--illustration-text);stroke-linecap:round;stroke-linejoin:round;stroke-width:1.17px"
				/>
				<polygon
					points="395.49 440.56 344.39 440.56 364.42 331.6 375.46 331.6 395.49 440.56"
					style="fill:var(--palette-bg);stroke:var(--illustration-text);stroke-linecap:round;stroke-linejoin:round;stroke-width:1.17px"
				/>
				<polygon
				...
				<line
					...
					x2="389.09"
					y2="429.82"
					style="stroke:var(--illustration-text);stroke-linecap:round;stroke-linejoin:round;stroke-width:1.17px"
				/>
				<line
					x1="373.22"
					y1="337.62"
			...
			<g id="freepik--Floor--inject-4">
				<line
					...
					x2="456.92"
					y2="446.5"
					style="stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.17px"
				/>
				<line
					x1="39.37"
					y1="446.5"
