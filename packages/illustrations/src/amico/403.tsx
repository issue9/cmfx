		...
		>
			...
			<g id="freepik--Door--inject-121">
				...
				<g id="freepik--door--inject-121">
					<g id="freepik--door--inject-121">
						...
						<path
							...
							style="fill:currentColor;opacity:.43"
						/>
						<path
					...
					<g id="freepik--Close--inject-121">
						...
						<text
							...
							style="font-size:.6rem;fill:#fafafa"
						>
							ERROR
						</text>
					</g>
				...
				<g id="freepik--Tapes--inject-121">
					...
					<text x="114" y="276.5" transform="skewY(7.5)" style="font-size:.52rem;fill:#455a64">
			...
			<g id="freepik--Character--inject-121">
				...
				<use href="#illustrations-403-4" fill="currentColor" />
				<use href="#illustrations-403-4" style="fill:#fff;opacity:.7" />
				<path
					...
					style="opacity:0.1"
				/>
				<use href="#illustrations-403-5" fill="currentColor" />
				<use href="#illustrations-403-5" opacity=".1" />
				<path
				...
				<use href="#illustrations-403-6" fill="var(--palette-3-bg)" />
				<use href="#illustrations-403-6" style="fill:#fff;opacity:.3" />
				<path
					...
					style="opacity:.1"
				/>
				<use href="#illustrations-403-7" fill="currentColor" />
				<use href="#illustrations-403-7" style="fill:#fff;opacity:.65" />
				<use href="#illustrations-403-8" fill="currentColor" />
				<use href="#illustrations-403-8" style="fill:#fff;opacity:.65" />
				<use href="#illustrations-403-9" fill="currentColor" />
				<use href="#illustrations-403-9" opacity=".1" />
			...
			<g id="freepik--speech-bubble--inject-121">
				<use href="#illustrations-403-13" fill="currentColor" />
				<use href="#illustrations-403-13" opacity=".2" />
				<path
			...
			<g id="freepik--Plant--inject-121">
				<path
					...
					fill="#455a64"
				/>
				<use href="#illustrations-403-14" fill="#455a64" />
				<use href="#illustrations-403-14" style="fill:#fff;opacity:.1" />
				<path
				...
				<path
					...
					style="fill:#f5f5f5"
				/>
				<use href="#illustrations-403-15" fill="currentColor" />
				<use href="#illustrations-403-15" opacity=".3" />
				<path
					...
					fill="#fafafa"
				/>
				<use href="#illustrations-403-16" fill="currentColor" />
				<use href="#illustrations-403-16" opacity=".15" />
				<path
