	...
	return (
		...
		>
			...
			<g id="freepik--Device--inject-33">
				<use href="#illustrations-login-1" fill="currentColor" />
				<use href="#illustrations-login-1" opacity=".6" />
				<path
					...
					style="opacity:.3"
				/>
				<use href="#illustrations-login-2" fill="currentColor" />
				<use href="#illustrations-login-2" opacity=".3" />
				<path
					d="M231.6,305.28h0l-7.09-4.09a7.69,7.69,0,0,1-3.47-6V261.51l-61,35.26v33.66a7.68,7.68,0,0,0,3.48,6l7,4Z"
					style="opacity:.5"
				/>
				<use href="#illustrations-login-3" fill="currentColor" />
				<use href="#illustrations-login-3" opacity=".5" />
				<path
					...
					fill="currentColor"
				/>
				<use href="#illustrations-login-4" fill="currentColor" />
				<use href="#illustrations-login-4" opacity=".5" />
				<use href="#illustrations-login-5" fill="currentColor" />
				<use href="#illustrations-login-5" opacity=".5" />
				<path
				...
				<path
					...
					style="opacity:.3"
				/>
				<use href="#illustrations-login-6" fill="currentColor" />
				<use href="#illustrations-login-6" fill="#263238" />
				<path
			...
			<g id="freepik--Character--inject-33">
				...
				<use href="#illustrations-login-7" fill="currentColor" />
				<use href="#illustrations-login-7" opacity=".4" />
				<use href="#illustrations-login-8" fill="currentColor" />
				<use href="#illustrations-login-8" opacity=".4" />
				<path
				...
				<path
					...
					style="fill:#fff;opacity:.4"
				/>
				<use href="#illustrations-login-9" fill="currentColor" />
				<use href="#illustrations-login-9" opacity=".1" />
				<polygon
