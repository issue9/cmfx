	...
	return (
		...
		>
			...
			<g id="freepik--error-500--inject-92">
				<text x="200" y="280" transform="skewY(-30)" style="font-size:3.7rem;font-weight:bold;fill:currentColor">
					500
				</text>
				<text
					x="205"
					y="315"
					transform="skewY(-30)"
					style="font-size:.9rem;font-weight:bold;fill:var(--palette-fg-low)"
				>
					{props.text || l.t('_i.internalServerError')}
				</text>
				<path
