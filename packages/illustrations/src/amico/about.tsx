...
export default function About(props: Props): JSX.Element {
	...
	return (
		<svg {...buildSVGProps(props)}>
			<title>{props.text || l.t('_i.about')}</title>
			<defs>
				<path
					id="illustrations-about-1"
				...
				/>
				<polygon
					id="illustrations-about-2"
					points="100.11 204.62 95.87 202.17 95.87 242.52 100.11 244.99 100.11 204.62"
				/>
				<path
					...
					id="illustrations-about-3"
				/>
				<path id="illustrations-about-4" d="M387,208.62s-5.64-.29-9.06,3.48-7.4,26.29-7.4,26.29,3.74,5.14,13.6,3Z" />
				<path
					id="illustrations-about-5"
				...
				/>
				<path id="illustrations-about-6" d="M265.5,233.43l8,2.08V218.58h0c-4.42-1.15-8,1.4-8,5.7Z" />
				<path
					id="illustrations-about-7"
				...
				/>
				<path
					id="illustrations-about-9"
					d="M274.05,207.42l0,3.59a1.69,1.69,0,0,0,1.76-1.72A1.86,1.86,0,0,0,274.05,207.42Z"
				/>
				<polygon
					id="illustrations-about-10"
					points="328.82 243.93 301.11 251.23 293.48 282.58 319.83 274.93 328.82 243.93"
				/>
				<path
					id="illustrations-about-11"
					d="M166.55,261a10,10,0,0,1,8,2c3.42,2.6,18,16,18,16s.4,7.09-7,11.31l-17.87-12.6Z"
				/>
				<path
					id="illustrations-about-12"
				...
				/>
				<path
					id="illustrations-about-14"
					d="M422.06,195.8c1.69-2.24,5.11,2.73,6.69,6.16s1.61,5.37.31,6.73-3.75.54-6.2-2.71S421.09,197.45,422.06,195.8Z"
				/>
			</defs>
			<ellipse cx="244.99" cy="349.69" rx="225.05" ry="129.93" fill="var(--palette-2-bg-low)" />
			<ellipse cx="283.51" cy="397.24" rx="41.38" ry="23.89" fill="var(--palette-2-bg)" />
			<ellipse cx="391.16" cy="383.09" rx="41.38" ry="23.89" fill="var(--palette-2-bg)" />
			<ellipse cx="164.82" cy="433.06" rx="41.38" ry="23.89" fill="var(--palette-2-bg)" />

			<g id="freepik--Page--inject-23">
				<path
				...
				<use href="#illustrations-about-1" fill="currentColor" />
				<use href="#illustrations-about-1" style="fill:#e0e0e0;opacity:.81" />
				<use href="#illustrations-about-2" fill="currentColor" />
				<use href="#illustrations-about-2" opacity=".15" />
				<path
				...
				/>
				<use href="#illustrations-about-3" fill="currentColor" />
				<use href="#illustrations-about-3" style="fill:#fff;opacity:.9" />
				<path
				...
				/>
				<polygon points="100.11 204.62 100.11 244.99 349.78 100.86 349.78 60.48 100.11 204.62" fill="currentColor" />
				<path
				...
				<polygon points="100.11 189.95 100.11 204.62 95.87 202.17 95.87 187.51 100.11 189.95" fill="#e0e0e0" />
				<text
					x="335"
					y="290"
					transform="skewY(-30)"
					text-anchor="end"
					style="font-size:1.2rem;font-weight:bold;fill:var(--palette-bg-low)"
				>
					{props.text || l.t('_i.about')}
				</text>
				<polygon
					points="110.94 254.51 179.99 214.64 179.99 327.21 110.74 366.97 110.94 254.51"
			...
			<g id="freepik--character-3--inject-23">
				<path
					...
					fill="#ffa8a7"
				/>
				<use href="#illustrations-about-4" fill="currentColor" />
				<use href="#illustrations-about-4" opacity=".3" />
				<rect x="405.84" y="368.38" width="7.57" height="13.5" fill="#ffa8a7" />
				<polygon points="387.16 367.66 379.59 367.94 379.21 353.65 387.16 353.38 387.16 367.66" fill="#ffa8a7" />
				<path
				...
				<path
					...
					fill="#263238"
				/>
				<path d="M393.59,280.26a27.75,27.75,0,0,1-10.54-6.3s2,4,8.08,7.66l-1.29,34.18Z" fill="#263238" />
				<path
					...
					fill="currentColor"
				/>
				<polygon points="393.71 216.34 392.35 225.82 389.19 225.76 392.76 226.33 393.71 216.34" opacity=".3" />
				<path
					...
					fill="#263238"
				/>
				<path d="M408,190.81s-1.73,8.46-2.42,9.85a3.66,3.66,0,0,1-2.12,1.78l.12-5.95Z" fill="#263238" />
				<path d="M405.86,178.69s1.24-.31,2.56,1.75c1.13,1.76,1.39,5.72-.39,10.37l-3.25.39Z" fill="#263238" />
				<path
				...
				<path
					...
					fill="#263238"
				/>
				<path d="M405.86,179.2l3.95-2.21a2.14,2.14,0,0,0-3-1A2.51,2.51,0,0,0,405.86,179.2Z" fill="#263238" />
				<path
					d="M391.74,205.46s5.85-1.23,7.9-2.36a6.92,6.92,0,0,0,2.83-2.92,9.71,9.71,0,0,1-1.61,3.44c-1.49,2-9.12,3.46-9.12,3.46Z"
					fill="#f28f8f"
				/>
				<circle cx="394.5" cy="189.3" r="1.1" fill="#263238" />
				<path d="M395,184.62l2.51,1.44A1.6,1.6,0,0,0,397,184,1.37,1.37,0,0,0,395,184.62Z" fill="#263238" />
				<path d="M392.27,198.12l-2.68,1a1.4,1.4,0,0,0,1.82.93A1.58,1.58,0,0,0,392.27,198.12Z" fill="#f28f8f" />
				<path d="M382.38,185.69l2.29-1.84a1.35,1.35,0,0,0-2-.31A1.62,1.62,0,0,0,382.38,185.69Z" fill="#263238" />
				<circle cx="384.5" cy="189.2" r="1.1" fill="#263238" />
				<polygon points="389.67 188.35 389.53 195.76 385.32 194.79 389.67 188.35" fill="#f28f8f" />
				<use href="#illustrations-about-14" fill="currentColor" />
				<use href="#illustrations-about-14" opacity=".5" />
				<path
					...
					fill="#ffa8a7"
				/>
				<use href="#illustrations-about-13" fill="currentColor" />
				<use href="#illustrations-about-13" opacity=".3" />
			</g>
			<g id="freepik--character-2--inject-23">
				<polygon points="306.42 242.85 312.39 250.8 305.97 258.15 297.7 248.48 306.42 242.85" fill="#f28f8f" />
				<path
				...
				<path
					...
					fill="#ffbda7"
				/>
				<use href="#illustrations-about-5" fill="currentColor" />
				<use href="#illustrations-about-5" opacity=".5" />
				<use href="#illustrations-about-6" fill="currentColor" />
				<use href="#illustrations-about-6" opacity=".6" />
				<use href="#illustrations-about-7" fill="currentColor" />
				<use href="#illustrations-about-7" opacity=".6" />
				<use href="#illustrations-about-8" fill="currentColor" />
				<use href="#illustrations-about-8" opacity=".6" />
				<path
				...
				<path
					...
					fill="#ffbda7"
				/>
				<circle cx="292" cy="207.5" r="1.1" fill="#263238" />
				<circle cx="283.2" cy="208" r="1.1" fill="#263238" />
				<path d="M284.73,215l2.67.87a1.37,1.37,0,0,1-1.73,1A1.54,1.54,0,0,1,284.73,215Z" fill="#f79776" />
				<path d="M294,204.09l-2.43-.83a1.19,1.19,0,0,1,1.55-.85A1.42,1.42,0,0,1,294,204.09Z" fill="#263238" />
				<use href="#illustrations-about-9" fill="currentColor" />
				<use href="#illustrations-about-9" opacity=".6" />
				<polygon points="287.42 206.12 287.4 213.08 290.64 212.01 287.42 206.12" fill="#f79776" />
				<path d="M284.35,220.93c-2.63-.34-8-1.93-8.89-4.15a5.8,5.8,0,0,0,1.91,2.83c1.62,1.43,7,3,7,3Z" fill="#f79776" />
				<path
				...
				<path
					...
					fill="#455a64"
				/>
				<use href="#illustrations-about-10" fill="currentColor" />
				<use href="#illustrations-about-10" opacity=".25" />
				<path
				...
				/>
				<path
					d="M320.85,249l.23-1.06c.13-.58-1.5-.61-3.63,0l-4.09,1c-2.13.56-4,1.48-4.09,2.06l-.22,1.06Z"
					fill="var(--palette-3-bg)"
				/>
				<path
			...
			<g id="freepik--character-1--inject-23">
				<path
					...
					fill="#914f4e"
				/>
				<use href="#illustrations-about-11" fill="currentColor" />
				<use href="#illustrations-about-11" opacity=".3" />
				<rect x="141.73" y="420.96" width="7.57" height="13.5" fill="#914f4e" />
				<polygon points="167.98 420.24 175.55 420.51 175.93 406.22 167.98 405.95 167.98 420.24" fill="#914f4e" />
				<path
				...
				<path
					...
					fill="#263238"
				/>
				<path d="M161.55,332.83a27.75,27.75,0,0,0,10.54-6.3s-2,4-8.08,7.66l1.29,34.19Z" fill="#263238" />
				<path
					...
					fill="currentColor"
				/>
				<polygon points="161.43 268.92 162.79 278.4 165.96 278.34 162.38 278.9 161.43 268.92" opacity=".3" />
				<path
					...
					fill="#914f4e"
				/>
				<use href="#illustrations-about-12" fill="currentColor" />
				<use href="#illustrations-about-12" opacity=".3" />
				<path d="M154.28,237.51a11.28,11.28,0,1,0,11.27-11.74A11.52,11.52,0,0,0,154.28,237.51Z" fill="#263238" />
				<path d="M147.11,243.38s1.73,8.46,2.42,9.85a3.7,3.7,0,0,0,2.13,1.79l-.13-6Z" fill="#263238" />
				<path d="M149.28,231.26S148,231,146.72,233c-1.13,1.76-1.38,5.72.39,10.37l3.25.39Z" fill="#263238" />
				<path
				...
				<path
					...
					fill="#263238"
				/>
				<path d="M149.28,231.77l-3.94-2.21a2.13,2.13,0,0,1,3-1A2.51,2.51,0,0,1,149.28,231.77Z" fill="#263238" />
				<path
					d="M163.4,258s-5.85-1.23-7.9-2.36a6.86,6.86,0,0,1-2.83-2.92,9.71,9.71,0,0,0,1.61,3.44c1.49,2,9.12,3.47,9.12,3.47Z"
					fill="#783736"
				/>
				<circle cx="160" cy="241.9" r="1.1" fill="#263238" />
				<path d="M159.27,236.82l-2.51,1.44a1.6,1.6,0,0,1,.58-2.08A1.38,1.38,0,0,1,159.27,236.82Z" fill="#263238" />
				<path d="M162.87,250.69l2.68,1.05a1.39,1.39,0,0,1-1.82.92A1.58,1.58,0,0,1,162.87,250.69Z" fill="#783736" />
				<path d="M173,238.22l-2.64-1.28a1.35,1.35,0,0,1,1.87-.75A1.62,1.62,0,0,1,173,238.22Z" fill="#263238" />
				<circle cx="170" cy="241.9" r="1.1" fill="#263238" />
				<polygon points="164.62 240.99 164.75 248.4 168.96 247.44 164.62 240.99" fill="#783736" />
				<path
				...
				<path
					...
					fill="#263238"
				/>
				<rect x="150.36" y="241.04" width="5.96" height=".59" fill="#263238" />
			</g>
		</svg>
	);
}
