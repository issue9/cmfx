...
// https://storyset.com/illustration/404-error/bro
export default function BroError404(props: Props): JSX.Element {
	const l = useLocale();
	...
	return (
		<svg {...buildStorySetProps(props)}>
			...
			/>
			<g id="freepik--Hole--inject-5">
				<ellipse
					cx="341.49"
					cy="385.79"
					rx="72.2"
					ry="21.42"
					style="fill:var(--illustration-text);stroke:var(--illustration-text);stroke-linecap:round;stroke-linejoin:round;stroke-width:1.193px"
				/>
				<path
					...
					style="fill:var(--illustration-bg);stroke:var(--illustration-text);stroke-linecap:round;stroke-linejoin:round;stroke-width:1.193px"
				/>
				<path
					d="M331.63,404.52c-24.12-1.09-42.32-6-42.32-12a3.33,3.33,0,0,1,.59-1.83"
					style="fill:none;stroke:var(--illustration-bg);stroke-linecap:round;stroke-linejoin:round;stroke-width:1.193px"
				/>
				<path
			...
			<g id="freepik--Clouds--inject-5">
				<path
					...
					style="fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.193px"
				/>
				<path
			...
			<g id="freepik--Character--inject-5">
				...
				<path
					...
					style="fill:var(--palette-bg);stroke:#263238;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.193px"
				/>
				<path
				...
				<rect
					...
					width="103.74"
					height="83.12"
					style="fill:var(--palette-bg);stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.193px"
				/>
				<path d="M338.48,273.34v-4.76a1.19,1.19,0,0,0-2.38,0v4.76Z" fill="#263238" />
				<path
				...
				/>
				<path d="M159.34,252.07a1.68,1.68,0,1,1-1.67-1.68A1.67,1.67,0,0,1,159.34,252.07Z" fill="#263238" />
				<path
			...
			<text x="100" y="140" text-anchor="start" style="font-size:1.5rem;fill:currentColor">
				{props.text || l.t('_i.pageNotFound')}
			</text>
			<text x="341" y="331" text-anchor="middle" style="font-size:3.5rem;font-weight:bold;fill:currentColor">
				404
			</text>
		</svg>
	);
