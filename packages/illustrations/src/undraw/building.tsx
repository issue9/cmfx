...
export default function UndrawBuilding(props: Props): JSX.Element {
	const l = useLocale();
		...
		>
			...
			<g transform="translate(-28.583 -435)">
				...
				<rect
					...
					fill="var(--palette-4-bg)"
				/>
				<rect width="6.833" height="3.576" rx="1.561" transform="translate(624.85 877.98)" fill="var(--palette-4-bg)" />
				<rect
					width="6.833"
					height="3.576"
					rx="1.561"
				...
				<ellipse
					...
					fill="var(--palette-2-bg-high)"
				/>
				<path d="M0,0H138.582l2.729,9.163H0Z" transform="translate(544.477 928.654)" fill="var(--palette-2-bg-high)" />
				<path
