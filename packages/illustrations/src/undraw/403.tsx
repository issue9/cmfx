...
export default function UndrawError401(props: Props): JSX.Element {
	...
	return (
		...
		>
			...
			<path
				id="ad903c08-5677-4dbe-a9c7-05a0eb46801f-2695"
				data-name="Path 461"
			...
			/>
			<path
				id="a94887ac-0642-4b28-b311-c351a0f7f12b-2696"
				data-name="Path 462"
			...
			<path
				...
				fill="var(--palette-4-fg)"
			/>
			<rect x="226.50312" y="172.03238" width="10.77161" height="2" fill="var(--palette-4-fg)" />
			<rect x="192.50312" y="172.03238" width="10.77161" height="2" fill="var(--palette-4-fg)" />
			<path
