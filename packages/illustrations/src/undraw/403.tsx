...
export default function UndrawError403(props: Props): JSX.Element {
	const l = useLocale();
	...
	return (
		...
		>
			...
			<path
				...
				fill="var(--palette-3-bg)"
			/>
			<rect x="226.50312" y="172.03238" width="10.77161" height="2" fill="var(--palette-3-bg)" />
			<rect x="192.50312" y="172.03238" width="10.77161" height="2" fill="var(--palette-3-bg)" />
			<path
			...
			<rect
				...
				fill="var(--palette-2-bg-low)"
			/>
			<circle cx="288.67474" cy="71.34324" r="3.4425" fill="var(--palette-4-bg)" />
			<circle cx="301.6071" cy="69.47507" r="3.4425" fill="var(--palette-4-bg)" />
			<circle cx="314.54005" cy="67.6068" r="3.4425" fill="var(--palette-4-bg)" />
			<rect x="370.25796" y="100.18309" width="437.1948" height="207.45652" fill="var(--palette-2-bg)" />
			<rect x="382.75969" y="117.97286" width="412.19197" height="173.08746" fill="var(--palette-4-bg)" />
			<rect x="370.07154" y="88.19711" width="437.19481" height="18.57334" fill="var(--palette-2-bg-low)" />
			<circle cx="383.87383" cy="99.11864" r="3.4425" fill="var(--palette-4-bg)" />
			<circle cx="396.94043" cy="99.11864" r="3.4425" fill="var(--palette-4-bg)" />
			<circle cx="410.00762" cy="99.11864" r="3.4425" fill="var(--palette-4-bg)" />
			<rect x="620.27691" y="144.28855" width="58.05212" height="4.36334" fill="var(--palette-2-bg)" />
			<rect x="620.27691" y="157.09784" width="89.64514" height="4.36332" fill="var(--palette-2-bg)" />
			<rect x="621.20899" y="169.29697" width="73.05881" height="4.36332" fill="var(--palette-2-bg)" />
			<rect x="620.27691" y="182.68222" width="42.65054" height="4.36332" fill="var(--palette-2-bg)" />
			<rect x="620.27691" y="195.75677" width="64.37073" height="4.36332" fill="var(--palette-2-bg)" />
			<rect x="593.81776" y="142.916" width="7.10843" height="7.10842" fill="var(--palette-2-bg)" />
			<rect x="593.81776" y="155.72527" width="7.10843" height="7.10841" fill="var(--palette-2-bg)" />
			<rect x="593.81776" y="167.92442" width="7.10843" height="7.10843" fill="var(--palette-2-bg)" />
			<rect x="593.81776" y="181.30967" width="7.10843" height="7.10843" fill="var(--palette-2-bg)" />
			<rect x="593.81776" y="194.38423" width="7.10843" height="7.10843" fill="var(--palette-2-bg)" />
			<rect x="620.27691" y="208.91306" width="58.05212" height="4.36332" fill="var(--palette-2-bg)" />
			<rect x="620.27691" y="221.72236" width="89.64514" height="4.36332" fill="var(--palette-2-bg)" />
			<rect x="621.20899" y="233.92149" width="73.05881" height="4.36332" fill="var(--palette-2-bg)" />
			<rect x="620.27691" y="247.30674" width="42.65054" height="4.36332" fill="var(--palette-2-bg)" />
			<rect x="620.27691" y="260.38129" width="64.37073" height="4.36332" fill="var(--palette-2-bg)" />
			<rect x="593.81776" y="207.54051" width="7.10843" height="7.10843" fill="var(--palette-2-bg)" />
			<rect x="593.81776" y="220.34979" width="7.10843" height="7.10841" fill="var(--palette-2-bg)" />
			<rect x="593.81776" y="232.54894" width="7.10843" height="7.10843" fill="var(--palette-2-bg)" />
			<rect x="593.81776" y="245.93419" width="7.10843" height="7.10843" fill="var(--palette-2-bg)" />
			<rect x="593.81776" y="259.00875" width="7.10843" height="7.10843" fill="var(--palette-2-bg)" />
			<rect x="436.63003" y="243.13905" width="58.05213" height="4.36333" fill="var(--palette-2-bg)" />
			<rect x="428.86266" y="254.4769" width="73.05881" height="4.36332" fill="var(--palette-2-bg)" />
			<path
				d="M699.66075,388.1056a37.91872,37.91872,0,0,1-55.87819,33.382l-.00736-.00737a37.907,37.907,0,1,1,55.88555-33.37461Z"
				transform="translate(-196.27362 -200.00788)"
				fill="var(--palette-2-bg)"
			/>
			<circle cx="465.67554" cy="175.95347" r="10.30421" fill="var(--palette-4-bg)" />
			<path
