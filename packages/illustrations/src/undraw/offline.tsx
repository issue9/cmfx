...
export default function UndrawEmpty(props: Props): JSX.Element {
	const l = useLocale();
		...
		>
			...
			<g transform="translate(-368.866 -254.661)">
				...
				<path
					...
					fill="currentColor"
				/>
				<circle cx="2.055" cy="2.055" r="2.055" transform="translate(973.854 360.516)" fill="var(--palette-4-bg)" />
				<path
				...
				<path
					...
					fill="currentColor"
				/>
				<rect width="53.498" height="6.079" transform="translate(436.671 272.899)" fill="var(--palette-4-bg)" />
				<circle cx="3.648" cy="3.648" r="3.648" transform="translate(557.041 272.899)" fill="var(--palette-4-bg)" />
				<circle cx="3.648" cy="3.648" r="3.648" transform="translate(569.2 272.899)" fill="var(--palette-4-bg)" />
				<circle cx="3.648" cy="3.648" r="3.648" transform="translate(581.358 272.899)" fill="var(--palette-4-bg)" />
				<path
					...
					fill="var(--palette-4-bg-low)"
				/>
				<rect width="53.498" height="6.079" transform="translate(436.671 359.225)" fill="currentColor" />
				<circle cx="3.648" cy="3.648" r="3.648" transform="translate(557.041 359.225)" fill="currentColor" />
				<circle cx="3.648" cy="3.648" r="3.648" transform="translate(569.2 359.225)" fill="currentColor" />
				<circle cx="3.648" cy="3.648" r="3.648" transform="translate(581.358 359.225)" fill="currentColor" />
				<path
					...
					fill="var(--palette-4-bg-low)"
				/>
				<rect width="53.498" height="6.079" transform="translate(436.671 445.552)" fill="currentColor" />
				<circle cx="3.648" cy="3.648" r="3.648" transform="translate(557.041 445.552)" fill="currentColor" />
				<circle cx="3.648" cy="3.648" r="3.648" transform="translate(569.2 445.552)" fill="currentColor" />
				<circle cx="3.648" cy="3.648" r="3.648" transform="translate(581.358 445.552)" fill="currentColor" />
