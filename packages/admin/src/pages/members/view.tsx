...
export function View(props: Props): JSX.Element {
    ...
    return <Page title='_p.member.view' class={ joinClass('max-w-lg', styles.view) }>
        <div class={styles.info}>
            ...
            <div class={styles.item}>
                <dl><dt class="mr-2">{l.t('_p.created')}</dt><dd>{ l.datetime.format(member().created) }</dd></dl>
                <dl><dt class="mr-2">{l.t('_p.member.birthday')}</dt><dd>{l.datetime.format(member().birthday) }</dd></dl>
            </div>
